...
# openssh-server
wget --no-cache -O openssh-server-install.sh https://raw.githubusercontent.com/rthomaz/Infraestrutura/master/scripts/openssh-server-install.sh
chmod 700 openssh-server-install.sh

wget --no-cache -O openssh-server-config.sh https://raw.githubusercontent.com/rthomaz/Infraestrutura/master/scripts/openssh-server-config.sh
...
# memberserver
wget --no-cache -O memberserver-install.sh https://raw.githubusercontent.com/rthomaz/Infraestrutura/master/scripts/memberserver-install.sh
